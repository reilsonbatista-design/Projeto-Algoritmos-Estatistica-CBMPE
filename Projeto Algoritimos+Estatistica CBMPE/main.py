...
from estatistica import executar_analise_estatistica # <<--- IMPORTAÇÃO DA ESTATÍSTICA
...
def filtrar():
  ...
  for index, ocorrencia in filtradas.iterrows(): 
    print(dict(ocorrencia))
...
def menu():
  while True:
    ...
    if escolha == '1':
      ...
      rodar_estatistica() # <<--- CHAMADA DA NOVA FUNÇÃO
